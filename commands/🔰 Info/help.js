  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_dc = new MessageButton().setStyle('url').setLabel('Get your Own Bot').setURL("https://discord.gg/FTbJmrVq5t")
        let button_invite = new MessageButton().setStyle('url').setLabel('Invite Public Version').setURL("https://discord.com/api/oauth2/authorize?client_id=815949826034106368&permissions=8&redirect_uri=https%3A%2F%2Fdashboard.botghost.com%2Fdashboard&scope=bot")
        ...
        let button_cat_advertisement = new MessageButton().setStyle('blurple').setID('button_cat_advertisement').setLabel('​Advertisement').setEmoji("852850790418874379")
...
📶 **\`${Math.floor(client.ws.ping)}ms\` Ping**`)        
        ...
        let d_button_dc = new MessageButton().setStyle('url').setLabel('Get your Own Bot').setURL("https://discord.gg/FTbJmrVq5t");
        let d_button_invite = new MessageButton().setStyle('url').setLabel('Invite Public Version').setURL("https://discord.com/api/oauth2/authorize?client_id=815949826034106368&permissions=8&redirect_uri=https%3A%2F%2Fdashboard.botghost.com%2Fdashboard&scope=bot");
