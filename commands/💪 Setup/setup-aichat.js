  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if (timeouterror)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<:no:833101993668771842> PLEASE CONTACT `𝖏𝖔𝖐𝖊𝖗#0009#6966`")
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
        );
      }
...
/**
 * @INFO
 * Bot Coded by 𝖏𝖔𝖐𝖊𝖗#0009#6966 | https://github.com/𝖏𝖔𝖐𝖊𝖗#00096966/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
